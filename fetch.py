...
The source is the Hong Kong Observatory's all-years record of the daily total
cloud-to-ground lightning count over Hong Kong territory.
"""
...
URL = (
    "https://data.weather.gov.hk/weatherAPI/cis/csvfile/HK/ALL/"
    "daily_HK_LGTG_ALL.csv"
)
